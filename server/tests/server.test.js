...
describe('DELETE /todos/:id', () => {
    ...
    it('should remove a todo', (done) => {
        ...
        it('should not remove a todo if its not yours', (done) => {
...
describe('PATCH /todos/:id', () => {
    ...
    it('should clear completedAt when todo is not completed', (done) => {
        //gra id of second todo
        //update, text, set completed to false
        //200
        //text is changed, completed false, completedAt is null .toNoExist
        ...
        request(app)
            ...
            .expect(200)
            .expect((res) => {
                expect(res.body.todo.text).toBe('Updated todo 2');
